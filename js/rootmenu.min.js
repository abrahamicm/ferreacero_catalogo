...
require(["jquery"], function ($) {
    $(document).ready(function () {
        ...
        if ("ontouchstart" in window) {
            $(".rootmenu-list li a").click(function (e) {
                if (window.innerWidth >= mobileMaxWidth) {
                    if (
                        $(this).closest("li").children(".halfmenu").length ||
        ...
        jQuery(".verticalmenu02 .vertical-list li")
            .has(".varticalmenu_main")
            .prepend(
                '<span class="desktop-vertical-click"><i class="verticalmenu-arrow fa fa-angle-right" aria-hidden="true"></i></span><span class="vertical-click"><i class="verticalmenu-arrow fa fa-angle-down" aria-hidden="true"></i></span>'
            );
